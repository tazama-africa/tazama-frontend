<template>
    <div class="min-h-screen flex flex-col">
        ...
        <div class="fixed top-0 left-0 w-full h-[13vh] bg-cover bg-center overflow-x-hidden z-10"
            style="background-image: url('https://newsroom.safaricom.co.ke/wp-content/uploads/2022/04/1400x788px-1-1.jpg');  ">
            <!-- Gradient Overlay -->
            <div class="absolute inset-0 bg-gradient-to-t from-black via-black/70 via-60% to-transparent opacity-70">
            </div>
        ...
        <!-- List of Trips -->
        <div class="mt-[14vh] px-2 pb-4 flex-grow overflow-y-auto">
