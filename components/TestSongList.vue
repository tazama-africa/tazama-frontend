            ...
            <div class="font-small">
                <div class="flex items-center gap-2">
                    <div class="flex justify-center items-center">
                        <div class="flex items-center justify-center lg:p-2 p-0.5 lg:py-3 lg:text-sm text-xs text-gray-50 border border-gray-300 rounded-lg lg:w-10 lg:h-9 w-7 h-7 bg-gradient-to-l from-orange-600 to-yellow-600">
                    ...
                    <div class="font-bold lg:text-xl text-xs text-orange-600">Songs</div>
                </div>
            </div>
            <div class="flex">
                ...
                <div class="flex items-center justify-center space-x-3">
                    <button @click="toggleLike(row.id)" class="focus:outline-none transition-colors duration-200">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            ...
                            :stroke="likedSongs.has(row.id) ? 'orange' : 'currentColor'" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" class="transition-colors duration-200">
                            <path
